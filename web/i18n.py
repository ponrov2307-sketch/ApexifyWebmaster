...
_TRANSLATIONS: dict[str, dict[str, str]] = {
    "EN": {
        ...
        "copilot.lock_notice": "Please upgrade to VIP or PRO to use AI Copilot.",
    ...
    "TH": {
        ...
        "copilot.lock_notice": "กรุณาอัปเกรดเป็น VIP หรือ PRO เพื่อใช้งาน AI Copilot",
...
def _repair_mojibake(text: str) -> str:
    ...
    for _ in range(4):
        ...
        best_value = repaired
        best_score = baseline
        for source_encoding in _CANDIDATE_ENCODINGS:
            for mode in _CANDIDATE_ERROR_MODES:
    ...
    repaired = _cleanup_candidate(repaired)
